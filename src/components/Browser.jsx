            ...
            <div>
                <div className="flex flex-wrap bg-white w-full h-screen mt-28">
                    <div className="w-9/12 bg-white rounded p-3">
                        <span className="inline-block font-semibold text-xl text-gray-700 ml-5 lg:ml-20 md:ml-12 sm:ml-8 pb-4">Browser</span>
                        <div className="flex flex-wrap -m-4">
                            <div className="p-4 lg:w-1/3">
                                <div className="className h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
                                    <a href="/">
                                        <img alt="team" className="flex-shrink-0 rounded-lg w-28 h-36 object-cover object-center sm:mb-0 mb-4" src={Logo} />
                                    </a>
                            ...
                            <div className="p-4 lg:w-1/3">
                                <div className="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
                                    <a href="./Desc.html">
                                        <img alt="team" className="flex-shrink-0 rounded-lg w-28 h-36 object-cover object-center sm:mb-0 mb-4" src={Logo1} />
                                    </a>
                                    <div className="flex-grow sm:pl-4">
                                        <h2 className="title-font font-bold text-gray-700">Jak Of The bushveld</h2>
                                        <h3 className="text-gray-500 mb-3">Marius Oelsching</h3>
                    ...
                    <div className="w-3/12 bg-white rounded p-3">
                        <span className="inline-block font-semibold text-xl text-gray-700 ml-5 lg:ml-4 md:ml-2 sm:ml-0 pb-4">Category</span>
                        <ul className="space-y-2 text-sm">
                            <li>
                                <a href="./Category.html" className="flex items-center space-x-3 text-gray-700 p-2 rounded-md font-medium focus:shadow-outline">
                                    <span>
